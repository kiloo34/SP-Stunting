    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    {{ucfirst($subtitle)}} {{__('Data Kriteria')}} {{ucfirst($title)}} {{ucfirst($catin->name)}}
                </h3>
            </div>
            <form action="{{ route('bidan.catin.storeValue', $catin->id) }}" class="form-horizontal" method="post">
                @csrf
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href="{{ route('bidan.catin.index') }}" class="btn btn-danger btn-sm">Kembali</a>
